...
function ResultContent() {
  ...
  return (
    <main className={`min-h-screen w-full overflow-y-auto transition-colors duration-300 ${
      theme === "light"
      ...
      <div className="result-content-wrapper">
        <motion.div
          ...
          className="result-card-container relative z-10"
        >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={toggleTheme}
          className={`fixed bottom-8 right-8 p-2 rounded-full shadow-lg transition-all duration-300 z-50 ${
            theme === "light"
